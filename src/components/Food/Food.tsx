            ...
            <div className=''>
                <div className='relative z-50'>
                    ...
                    <div className="mb-6">
                        ...
                        <p className="">
                            Personalize your food choices to match healthy and tasty foods.
                        </p>
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <p className="">
                            Our AI algorithm can find unexpected foods or restaurants that match your health and dietary requirements.
                        </p>
                    </div>
